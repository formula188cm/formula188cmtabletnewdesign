    ...
    <footer className="bg-primary text-primary-foreground section-divider">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold">Formula188CM</span>
            </div>
            <p className="text-sm opacity-80">Premium height growth supplement for natural development.</p>
          </div>
        ...
        <div className="border-t border-primary-foreground/20 pt-8">
          <p className="text-center text-sm opacity-80">© 2025 Formula188CM. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
